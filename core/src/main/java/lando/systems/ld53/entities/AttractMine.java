...
public class AttractMine implements Influencer {
    ...
    public AttractMine(GameScreen screen, Vector2 position) {
        this.screen = screen;
        ...
        range.setNewValue(100f, TIME_TO_LIVE/2f);
        this.influenceRenderer = new InfluenceRenderer(this, Color.SKY);
    }
